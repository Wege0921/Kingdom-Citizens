...
export function InstallBanner() {
  ...
  return (
    <>
      <div className="fixed bottom-16 md:bottom-0 left-0 right-0 z-50 p-4 bg-primary text-primary-foreground border-t shadow-lg animate-in slide-in-from-bottom-5">
